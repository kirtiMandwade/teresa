...
public class CuentasAduaneras  extends AuditBase{
	...
	public String toString() {
		return "CuentasAduaneras [id=" + id + ", clave_del_Tipo_de_Registro=" + clave_del_Tipo_de_Registro + ", Número_Pedimento="
				+ Número_Pedimento + ", Emisora_Cuenta=" + Emisora_Cuenta + ", Número_Contrato=" + Número_Contrato
				+ ", Folio_Constancia=" + Folio_Constancia + ", Fecha_de_la_Constancia=" + Fecha_de_la_Constancia
				+ ", Tipo_Cuenta=" + Tipo_Cuenta + ", Tipo_de_Garantía=" + Tipo_de_Garantía + ", Valor_unitario_título="
				+ Valor_unitario_título + ", Importe_Total_Garantía=" + Importe_Total_Garantía
				+ ", Cantidad_Unidades_Medida=" + Cantidad_Unidades_Medida + ", Titulos_Asignados=" + Titulos_Asignados
				+ "]";
	}
