...
@Entity
@Table(name="`555`")
public class GarantíaNivelPartida extends AuditBase{
	...
	public String toString() {
		return "GarantíaNivelPartida [id=" + id + ", clave_del_Tipo_de_Registro=" + clave_del_Tipo_de_Registro + ", número_pedimento="
				+ número_pedimento + ", fracción_Arancelaria=" + fracción_Arancelaria + ", número_Partida="
				+ número_Partida + ", institución_Cuenta_Garantía=" + institución_Cuenta_Garantía
				+ ", número_Cuenta_Garantía=" + número_Cuenta_Garantía + ", folio_Constancia=" + folio_Constancia
				+ ", fecha_Constancia=" + fecha_Constancia + ", tipo_Garantía=" + tipo_Garantía
				+ ", valor_unitario_título=" + valor_unitario_título + ", importe_Total_Garantía="
				+ importe_Total_Garantía + ", cantidad_Unidades_Medida=" + cantidad_Unidades_Medida
