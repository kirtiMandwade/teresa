...
public class Descargos  extends AuditBase{
	...
	public String toString() {
		return "Descargos [id=" + id + ", clave_del_Tipo_de_Registro=" + clave_del_Tipo_de_Registro
				...
				+ número_Pedimento_operación_original + ", aduana_secció_realizó_operacion_original="
				+ aduana_secció_realizó_operacion_original
