...
@Entity
@Table(name="`800`")
public class FirmaElectrónicaPedimento extends AuditBase {
	...
	public FirmaElectrónicaPedimento() {
	...
	public String toString() {
		return "FirmaElectrónicaPedimento [id=" + id + ", clave_del_Tipo_de_Registro=" + clave_del_Tipo_de_Registro
				+ ", número_pedimento=" + número_pedimento + ", tipo_figura=" + tipo_figura
