...
@Entity
@Table(name="`701`")
public class Rectificación extends AuditBase {
	...
	public String toString() {
		return "Rectificación [id=" + id + ", clave_del_Tipo_de_Registro=" + clave_del_Tipo_de_Registro + ", patente_autorización="
				+ patente_autorización + ", número_Pedimento=" + número_Pedimento + ", aduana_sección_despacho="
				+ aduana_sección_despacho + ", clave_pedimento_rectificar=" + clave_pedimento_rectificar
				+ ", fecha_pago=" + fecha_pago + ", número_Pedimento_operacion_original_rectificación="
