...
public class Permisos extends AuditBase{
	...
	public String toString() {
		return "Permisos [id=" + id + ", clave_del_Tipo_de_Registro=" + clave_del_Tipo_de_Registro + ", número_pedimento="
				+ número_pedimento + ", fracción_Arancelaria=" + fracción_Arancelaria + ", número_Partida="
				+ número_Partida + ", clave_Permiso=" + clave_Permiso + ", firma_descargo=" + firma_descargo
				+ ", número_permisos_autorización=" + número_permisos_autorización + ", valor_comercial_dólares="
				+ valor_comercial_dólares + ", cantidad_Mercancía_UMTorUMC=" + cantidad_Mercancía_UMTorUMC + "]";
	}
