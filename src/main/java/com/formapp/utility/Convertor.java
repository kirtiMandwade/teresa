...
public class Convertor {
     ...
     * */
    public static ArrayList<JSONObject> getJSONFromExcel(String filePath)
    {
    	ArrayList<JSONObject> jsonString = null;
...
//            }
    ...
    private static ArrayList<JSONObject> getJSONStringFromList(List<List<String>> dataTable)
    {
//        JSONArray tableJsonObject= new JSONArray();
ArrayList<JSONObject> tableJsonObject= new ArrayList<>();
